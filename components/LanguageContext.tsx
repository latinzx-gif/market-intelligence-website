...
const translations = {
  en: {
    ...
    home: {
      ...
      reportsEyebrow: "Intelligence Repository",
      reportsH2: "Available Market Reports",
      reportsP: "In-depth category maps for student cognitive nutrition and functional beverages in Thailand.",
      viewReport: "Browse Repository",
  ...
  th: {
    ...
    home: {
      ...
      reportsEyebrow: "คลังข้อมูลอัจฉริยะ",
      reportsH2: "รายงานข้อมูลตลาดที่พร้อมใช้งาน",
      reportsP: "แผนผังข้อมูลเชิงลึกในหมวดหมู่โภชนาการสมองและเครื่องดื่มฟังก์ชันสำหรับนักเรียนในไทย",
      viewReport: "สำรวจคลังรายงาน",
